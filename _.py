...
Фокусировка: элементы, которые вы хотите выделить, должны быть более яркими, контрастными или большими, чем остальные.'''},
            ...
            (
                {'text': '''
                Тени являются важным элементом в рисовании, который может добавить глубину и объем в ваше изображение. В этом уроке мы рассмотрим, как использовать тени для создания объема в рисовании.
                Шаг 1: Определите источник света
...
Цель или намерение приготовления - убедиться, что приготовленная пища претерпевает физические изменения, иногда химические изменения, и с удовольствием приемлема для употребления в пищу человеком.''', 
...
Суши, Япония. Японскую кухню невозможно представить без суши. Состоит это блюдо из риса и начинки из овощей или рыбы.
...
Кимчхи, Корея. Главное место в корейской кухне занимает кимчхи — квашеные овощи с острыми приправами. Основным компонентом блюда является пекинская капуста. К ней добавляют острый перец, лук, имбирь и чеснок и другие овощи по вкусу или растения семейства крестоцветных.
...
'''}
        ...
        'high': (
            (
{'text': '''
Нет ничего лучше кулинарных проектов, чтобы сосредоточиться и дать работу праздным рукам. Будь то приготовление оригинального семейного ужина, заготовки на неделю или разовый эксперимент со сложным десертом — это один из лучших способов направить энергию на выполнение одной задачи, требующей времени и внимания.
...
'''}
            ...
            (
{'text': '''
Создание авторских блюд - это не только кулинарное искусство, но и процесс, который требует воображения, творческого мышления и умения экспериментировать с ингредиентами. Этот урок расскажет о том, как создать свои авторские блюда.
...
Шаг 3: Создайте концепцию блюда
...
print(textLessons['cooking']['high'][0])
#[0]['text']
